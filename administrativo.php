...
<body>
	...
	<section id="areatotalcontenidos">
        ...
        <section id="titulogeneral2">
            <ul>
                <li>Bienvenido distinguido(a): <?php echo $_SESSION['usuario'];?>
		...
		<section id="titulogeneral2">
			<h1>INTERACTÚA ENTRE ADMINISTRATIVOS MEDIANTE ÉSTE FORMULARIO:</h1>
		</section><br>
        <section id="contenidos">
                <form id="contact-form" method="post" action="enviadatosadministrativo.php">
                    <fieldset>
                        <label>
                            <span>Nombres y Apellidos:</span>
                            <input  type="text" name="nadmin" placeholder="Escribe tus nombres y apellidos">
                        </label><br>
                        <label>
                            <span>Cargo:</span>
                            <select style="background: #e6e6fa; border-radius: 2px; border-color: #2f0000;" name="cadmin">
                                <option>Administrativo</option>
                            </select>
                        </label><br>
                        <label>
                            <span>Mensaje:</span> 
                            <textarea name="madmin" placeholder="Escribe tu mensaje aquí..."></textarea>
                        </label><br>
                        <div class="btns">
        ...
        <section id="titulogeneral4">
            <h1>LISTA DE DIÁLOGO E INTERACCIONES</h1>
        </section><br>
        ...
        <?php
		  foreach ($resultados as $fila) {
		      echo "<table width=\"100%\">";
			     ...
			     echo "<tr>";
				 echo "<th>".$fila['fecha']."<br>".$fila['nomadmi']."<br>".$fila['cargoadmi']." dice:"."<br>"."<br>".$fila['mensajeadmi']."</th>";	
    			 echo "</tr>"."<br>"."<br>"."<br>";	
			}
		?>
        </section>	
