...
<body>
	...
	<section id="areatotalcontenidos">
		<section id="titulogeneral2">
			<h1>INICIAR SESIÓN: PADRE DE FAMILIA</h1>
		</section><br>
        ...
        <section id="contenidos">
                ...
                <br><br>Estimado  padre de familia usted podrá enviar sus mensajes o comunicarse con los docentes responsables del área a fines.
                </p><br>
        </section>       
