...
<body>
	...
	<section id="areatotalcontenidos">
        ...
        <section id="titulogeneral2">
            <ul>
                <li>Bienvenido estimado(a): <?php echo $_SESSION['usuario'];?>
		...
		<section id="titulogeneral2">
			<h1>INTERACTÚA ENTRE DOCENTES MEDIANTE ÉSTE FORMULARIO:</h1>
		</section><br>
        <section id="contenidos">
                <form id="contact-form" method="post" action="enviadatosdocente.php">
                    <fieldset>
                        <label>
                            <span>Nombres y Apellidos:</span>
                            <input  type="text" name="ndocente" placeholder="Escribe tus nombres y apellidos">
                        </label><br>
                        <label>
                            <span>Cargo:</span>
                            <select style="background: #e6e6fa; border-radius: 2px; border-color: #2f0000;" name="cdocente">
                                <option>Docente</option>
                            </select>
                        </label><br>
                        <label>
                            <span>Mensaje:</span> 
                            <textarea name="mdocente" placeholder="Escribe tu mensaje aquí..."></textarea>
                        </label><br>
                        <div class="btns">
        ...
        <section id="titulogeneral4">
            <h1>LISTA DE DIÁLOGO E INTERACCIONES ENTRE DOCENTES</h1>
        </section><br>
        ...
        <?php
		  foreach ($resultados as $fila) {
		      echo "<table width=\"100%\">";
			     ...
			     echo "<tr>";
				 echo "<th>".$fila['fecha']."<br>".$fila['nomdocente']."<br>".$fila['cargodocente']." dice:"."<br>"."<br>".$fila['mendocente']."</th>";	
    			 echo "</tr>"."<br>"."<br>"."<br>";	
			}
		?>
        </section>	
